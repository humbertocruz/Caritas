...
<div class="row">
	<div class="col-md-2">
		<ul class="list-group">
			<li class="list-group-item" title="Salvar"><?php echo $this->Bootstrap->btnLink( 'Salvar', array(), array('forms'=>'#ChamadaAddForm, #ChamadaEditForm','style'=>'success','type'=>'btn-block')); ?></li>
			<li class="list-group-item" title="Salvar e Editar"><?php echo $this->Bootstrap->btnLink( 'Salvar e Editar', array(), array('style'=>'warning','type'=>'btn-block')); ?></li>
			<li class="list-group-item" title="Salvar e Finalizar"><?php echo $this->Bootstrap->btnLink( 'Salvar e Finalizar', array(), array('style'=>'warning','type'=>'btn-block')); ?></li>
			<li class="list-group-item" title="Cancelar"><?php echo $this->Bootstrap->btnLink( 'Cancelar', array('action'=>'index'),array('type'=>'btn-block')); ?></li>
		</ul>
	</div>
	<div class="col-md-10">
